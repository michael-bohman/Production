...
<summary>To add a stepper block, hit <code>/</code> on an empty line or click the <code>+</code> on the left of the editor and select <strong>Stepper</strong> from the insert menu.</summary>
