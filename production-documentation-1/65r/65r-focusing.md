...
For focusing 21030-04 cameras for PixelScout systems, refer to the PixelScout assembly steps. There are a few key differences in the process. [1-pixelscout-65r-focusing-change-process.md](../../technical-instructions/pixel-scout/assembly-steps/1-pixelscout-65r-focusing-change-process.md "mention")
