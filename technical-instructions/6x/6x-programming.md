...
8. Select the <mark style="color:blue;">update firmware tab</mark>&#x20;
...
4. Open the <mark style="color:blue;">hw\_config.yaml</mark> and update the serial number for the camera you have&#x20;
...
4. Click <mark style="color:blue;">firmware</mark> tab and confirm everything is up to date and showing the right numbers&#x20;
5. Click <mark style="color:blue;">Diagnostics</mark> tab and confirm the correct Part number and serial number is showing for your camera&#x20;
6. Open the <mark style="color:blue;">Home</mark> tab&#x20;
7. Find the Session button and rename to "Prog Test Session", Click <mark style="color:blue;">Start Session</mark>
8. Wait a few seconds and click Capture Image
