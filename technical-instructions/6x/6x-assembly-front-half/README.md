...
3. Place the filter in the corresponding position on the lens mount.
   1. Secure the lens with 3 contact points of UV bonder on the very edge of the lens.
   2.
...
4. Remove Kapton tape from all 3 of the imagers

> ![](<../../../.gitbook/assets/image (89).png>)    <img src="../../../.gitbook/assets/image (90).png" alt="" data-size="original">

5. Place the monochrome (right and left) and HD/mono (middle) imagers in the lens mount.
...
8. Install the lockring included with each 8mm lens. Repeat for all 5 lenses.
   1. Thread into the slots shown&#x20;

> ![](<../../../.gitbook/assets/image (101).png>)     ![](<../../../.gitbook/assets/image (102).png>)

9. Install the lockring to the 7.2mm lens&#x20;
   1. Thread into the bottom middle slot shown

> ![](<../../../.gitbook/assets/image (103).png>)    ![](<../../../.gitbook/assets/image (104).png>)

10. Attach the front assembly and rear assembly together.&#x20;
