...
2. Apply thermal paste to the middle of the raised surface on the heatsink.
   1. Keep the thermal paste as a bead and do not spread it. The thermal paste will spread naturally during the next step. You want more height than coverage.&#x20;
   2. Ensure that no thermal paste gets on the expansion board pins.
   3.
...
4. On the baseboard&#x20;
   1. Remove all Kapton tape from all electrical components
   2. Make sure the PPS switch is flipped to the “on” position on the 23119-01 baseboard.

> ![](<../../.gitbook/assets/image (72).png>)     ![](<../../.gitbook/assets/image (73).png>)

5. Mate the SOM and breakout board with the baseboard.
   1. Align the breakout pins with the pin interface on the baseboard.
   2. Do NOT bend pins or contacts.
   3.

       <figure><img src="../../.gitbook/assets/image (75).png" alt="" width="533"><figcaption></figcaption></figure>
   4. The connectors should be fully seated as shown.
   5.
...
8. Apply thermal paste to the backside of the SSD.
   1. Do not get thermal paste on the pins or on the edges of the SSD.
   2. Do not spread thermal paste. Keep the paste as a bead so that it spreads naturally when pressed against the baseboard.
   3.

       <figure><img src="../../.gitbook/assets/image (81).png" alt="" width="343"><figcaption></figcaption></figure>
9. Place the SSD into its port on the baseboard.
   1. The SSD will sit at an angle as shown in the image below.
   2.
