...
The process for 6X boards is nearly identical to the PixelScout process. The only difference is the serial number to register and where the cables plug in.
...
3. Connect one end of the green micro coax cable to the port on the back of the gimbal breakout board.

<figure><img src="../../../.gitbook/assets/IMG_9164.jpeg" alt="" width="375"><figcaption></figcaption></figure>

4. Place the gimbal breakout board into the rectangular jig and secure barely snugly using the 2 black course threaded screws included.

<figure><img src="../../../.gitbook/assets/IMG_9165.jpeg" alt="" width="375"><figcaption></figcaption></figure>

5. Switch the 'CTRL PROG' Switch on the motor controller board to 'ON'.
...
{% hint style="info" %}
If the license serial number required is not known, click on 'Web Control Panel'. Sign in and click 'Customers' and the top. The required serial number will be the next highest 23138-01\_rev- Serial Number.
{% endhint %}
...
6. Select/Adjust the following settings and click <mark style="color:blue;">Next</mark>.
   ...
   6. Board ID: <mark style="color:blue;">**23138-01\_rev-\_SNXXX**</mark>**.** (where XXX denotes the next few numbers from the Basecam website.
      1. Refer to the top of the programing section if the sn is not known.
...
11. Flip the 'CTRL PROG' switch on the motor controller board to 'OFF'.

<figure><img src="../../../.gitbook/assets/IMG_8153.jpg" alt="" width="563"><figcaption></figcaption></figure>

#### Basecam SimpleBGC GUI

1. Connect the other end of the green microcoax cable to the 'Gimbal' connection on the motor controller board.
...
7. Find the 6X Array 'Starting Point' EEPROM file and select <mark style="color:blue;">Open</mark>, then <mark style="color:blue;">Restore</mark> and <mark style="color:blue;">Yes</mark>.
...
12. Once the board IMU is calibrated, export the calibration data.
    ...
    2. Name: '<mark style="color:blue;">sbgc\_IMU\_calib\_21269-99SNXXX</mark>' or '<mark style="color:blue;">sbgc\_IMU\_calib\_21270-99SNXXX</mark>' where 'XXX' denotes the 6X Array serial number.
...
14. Upload the IMU calibration file to taurus in the following folder:
    1. "\as-taurus.jdnet.deere.com\Production\Systems & Kits\21269-00 — Sentinel Array" or "\as-taurus.jdnet.deere.com\Production\Systems & Kits\21270-XX — 6X Array"
       1. place in a SN folder
