...
3. Attach cap and arm.
   ...
   5. Hold second arm into place and feed shoulder <mark style="color:yellow;">#10 screws</mark> through the second arm, first arm, and into the cap. Secure with Loctite.
   6.
...
<p align="center"><img src="../../.gitbook/assets/unknown (33).jpeg" alt=""> </p>

{% hint style="info" %}
Check the entire gimbal for movement freedom by turning the arms and checking for any points of friction. If any friction occurs. Refer to fault isolation manual.&#x20;
{% endhint %}
