...
In addition to everything listed in the BOM, the following are required:
...
4. Attach the camera to the gimbal using the removed screw and 2 others with Loctite.
