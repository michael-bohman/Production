...
9. Thread the cable through the large hold in the yaw enclosure. Line it up on the top of the spacer being careful to keep the holes lined up. Secure using 4 screws (<mark style="color:yellow;">94017A108</mark>) and Loctite.
...
11. Line up the top of the gimbal using the 3 screw holes. Secure using 3 screws (<mark style="color:yellow;">94017A156</mark>) and Loctite.
...
12. Place the yaw cable cover over the stack by inserting the tab into the slot. Secure using 2 screws (<mark style="color:yellow;">95836A512</mark>) and Loctite.
