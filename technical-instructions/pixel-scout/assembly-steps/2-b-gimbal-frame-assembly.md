...
5. Feed the pitch motor and micro coax wires through the roll motor casing.

<figure><img src="../../../.gitbook/assets/IMG_7442.jpg" alt="" width="375"><figcaption></figcaption></figure>

6. Feed the pitch motor and micro coax cables through the center of the roll motor.
   1. Feed the roll motor cable through first as it will not fit if the micro coax is already in the motor.
   2. A hex screw driver may be used to push the JST connector through the motor.
...
9. Push the wires as far back as possible into the inside of the arm.
...
10. Feed all the wires through the roll encoder casing. There should be 4 cables.
    1. Micro Coax
    2. Pitch Motor
    3. Roll Motor
    4. Roll Encoder
...
The gimbal assembly is complete. Verify the quality of the build by checking a few things:

1. There is no binding/rubbing when turning either of the motors.
2. There are no pinched wires anywhere.
3. There is about 7.5" of micro coax cable protruding from the pitch motor.
