...
4. Place the back cover on the camera pod, secure using the top 2 screws (M3x6 Flat Head BLK 91698A302) and Loctite.
5.  While pulling the 2 gimbal cables taught, match the mating surfaces between the camera pod and the gimbal. Secure using 4 screws (M3x6 Flat Head BLK 91698A302) and Loctite.
...
6. Double check that 6 cables are present:
   ...
   4. 2 microcoax cables from the cameras.
   5. If any are missing, refer to previous steps to find how to correct it.
7.  Secure the other side of the camera pod using a shoulder screw, bearing, and Loctite.
...
{% hint style="info" %}
NOTE: 1 or 2 on the board does not correspond to primary and secondary, match cables to the components on the respective sides of the camera pod.
{% endhint %}
