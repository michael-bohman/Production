...
<figure><img src="../../.gitbook/assets/IMG_7921.jpg" alt="" width="563"><figcaption></figcaption></figure>

1. Take a photo such that the panel number is visible and the entire reflectance panel is in view.
2. Close the container with the tissue paper places squarely in between the two halves of the container with even overhang.
3. Place the sticker on the back of the case, position it in the lower right-hand corner.
   1. "lower" means the edge next to the latches.
4. Place the container into an S-9482 Poly Bag and seal with the Uline Sealer.
...
5. Upload photos to taurus with the panel number in the photo name.
