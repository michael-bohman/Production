...
This is a common issue that can happen when the autoexposure does not catch up when taking the focus images. Happens when the image adjustment button is on when taking focus pictures.&#x20;

***

Solution: Retake the focus images with image adjustment off
